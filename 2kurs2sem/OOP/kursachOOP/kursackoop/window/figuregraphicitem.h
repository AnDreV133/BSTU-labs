...
// signals:
//     void signalRemoveHighlite(std::vector<HighliteGraphicItem*> *allowedPosesGraphicItem);
//     void signalAddHighlite(std::vector<HighliteGraphicItem*> *allowedPosesGraphicItem);
};

...
LRESULT CALLBACK WindowProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    switch (message) {
        ...
        case WM_PAINT: {
            ...
            Frame frame(W, H);
//            Painter_Example painter;
            Painter_Var2 painter;
            painter.draw(frame);
        ...
        case WM_MOUSEMOVE: {
            ...
            sprintf_s(str, "Scale (F2/F3): %d", pixelSize);
        ...
        case WM_LBUTTONDOWN:
            ...
            globalClickedPixel.x = LOWORD(lParam) / pixelSize;
            globalClickedPixel.y = HIWORD(lParam) / pixelSize;
            // Перерисовать окно

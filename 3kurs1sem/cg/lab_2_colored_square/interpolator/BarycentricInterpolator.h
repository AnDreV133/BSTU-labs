...
#ifndef LAB_2_COLORED_SQUARE_BARYCENTRICINTERPOLATOR_H
#define LAB_2_COLORED_SQUARE_BARYCENTRICINTERPOLATOR_H
...
class BarycentricInterpolator : public BaseInterpolator {
...
#endif //LAB_2_COLORED_SQUARE_BARYCENTRICINTERPOLATOR_H
